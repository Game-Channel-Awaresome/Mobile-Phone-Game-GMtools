...
#     last_login = models.CharField(max_length=128)
...
class UdbUorder(models.Model):
    ...
    serverID = models.CharField(max_length=128)
...
class UdbUuser(models.Model):
    ...
    id = models.CharField(max_length=128, primary_key=True)
    lastLoginTime = models.CharField(max_length=128)
    appid = models.CharField(max_length=128)
